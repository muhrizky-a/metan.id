...
@section('style')
    ...
    <meta property="og:image" content="{{ url('/img/article/' . $article->image_url) }}" />
@endsection
    ...
    <div class="row">
        <div class="col-lg-8 article">
            <div class="article-tags">
                <a 
                    href="{{ $article->category ? route('category.page', $article->category->link) : '#' }}"
                    class="tags rounded"
                >
            ...
            <div class="article-footer">
                ...
                {{-- <div class="author-box">
                    <a href="#">
                        <img 
                            src="{{ asset('img/journalist/' . $article->journalist->image_url) }}" 
                            width="52px"
                            height="52px"
                        >
                    </a>
                ...
                <div style="color: #a5a5a5;" class="mb-2">
                    <i class="fa fa-share-alt" aria-hidden="true"></i>
                    <span>Bagikan</span>
                </div>
                <div class="flex">
                    <a 
                        href="https://www.facebook.com/sharer.php?u=https://www.metan.id/public/article/{{ $article->link }}"
                        target="_blank"
                        rel="noopener"
                    >
                    ...
                    <a 
                        href="https://api.whatsapp.com/send?text={{ $article->title }} %0A%0A https://www.metan.id/public/article/{{ $article->link }}"
                        target="_blank"
                        rel="noopener"
                    >
                ...
                <div class="card-group">
                    @foreach ($related_articles as $related_article)
                        <div class="card grid-card">
                            <img 
                                src="{{ asset('/img/article/' . $related_article->image_url) }}" 
                                class="card-img-top"
                                alt="{{ $related_article->title }}"
                            />
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="{{ route('article.detail', $related_article->link) }}">
